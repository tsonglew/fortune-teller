...
class RunnerService:
    ...
    def run(self, nums: List[int]) -> Optional[Result]:
        ...
        upper_divination = self._divination_util.get_divination_by_number(
            nums[0] % 8)
        under_divination = self._divination_util.get_divination_by_number(
            nums[1] % 8)
        ...
        return Result(
            start=SubResult(
                ...
                *self._double_divination_util.get_ti_yong_divination(
                ...
                self._luck_util.get_luck(ben_double_divination,
                                         moving_line_idx),
            ),
            process=SubResult(
                "互卦",
                ...
                *self._double_divination_util.get_ti_yong_divination(
                ...
                self._luck_util.get_luck(mutual_double_divination,
                                         moving_line_idx),
            ),
            end=SubResult(
                "变卦",
                ...
                *self._double_divination_util.get_ti_yong_divination(
                ...
                self._luck_util.get_luck(bian_double_divination,
                                         moving_line_idx),
            ),
